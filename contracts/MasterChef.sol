...
contract GlideToken is ERC20('BillionaireClub', 'CLUBBNAIR'), Ownable  {
    uint256 constant private _maxTotalSupply = 100000000000e18; // 100,000,000,000 max supply
...
contract MasterChef is Ownable, ReentrancyGuard {
    ...
    uint256 public constant MAX_EMISSION_RATE = 50 ether; // Safety check
